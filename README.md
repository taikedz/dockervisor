...
Here's an [example readme](assets/example-readme.md) that can be given to basic maintenance admins, for apps managed by jockler (also accessible any time via `jockler readme`).
